...
#  - Exports SSH_ASKPASS/SSH_ASKPASS_REQUIRE for ksshaskpass GUI password questions
...
#  - questions for the SSH username (to use; default from SSH_MENU_USER or $USER)
